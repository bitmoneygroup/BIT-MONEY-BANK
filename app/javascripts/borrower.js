...
import bank_artifacts from '../../build/contracts/BitMoneyBank.json';
import bank_artifacts2 from '../../build/contracts/Mortgage.json';

var BitMoneyBank = contract(bank_artifacts);
...
function getLoanState() {
  BitMoneyBank.deployed().then(function(contractInstance) {
    console.log(account);
...
$( document ).ready(function() {
  ...
  BitMoneyBank.setProvider(web3.currentProvider);
  showPastLoans();
  // $('#loan-rows').DataTable();
});
